...
public class GameMain extends JPanel implements MouseListener{
	...
	// declare game object variables the game board 
	private Board board;
	...
	public GameMain() {
		...
		// MouseListener detects instance of 'this'          
		...
		// new instance of the game "Board" class created
		 board = new Board();
	...
	public static void main(String[] args) {
		...
		javax.swing.SwingUtilities.invokeLater(new Runnable() {
	        public void run() {
		        ...
		        // Set frame to show one at a time
